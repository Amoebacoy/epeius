...
async function get特洛伊Config(password, hostName, sub, UA, RproxyIP, _url, env) {
	...
	<p>Welcome! This function generates configuration for the trojan protocol. If you found this useful, please check our GitHub project:</p>
	...
	<div class="subscription-info">
	  ...
	  <ul>
		<li><strong>TROJAN Subscription:</strong> Direct link for TROJAN protocol configuration. Suitable for clients supporting TROJAN.</li>
		...
		<li><strong>Clash Link:</strong> A web link to convert the TROJAN config to Clash format. Useful for manual import or troubleshooting.</li>
		<li><strong>Best IP Subscription:</strong> Provides a curated list of optimal server IPs for many <b>different countries</b>.</li>
	  </ul>
	  <p>Choose the option that best fits your client and needs. For most users, the TROJAN or Clash Subscription will be the easiest to use.</p>
	  ---------------------------------------------------------------<br>
	  ################################################################<br>
	  ${FileName} 配置信息<br>
	  ---------------------------------------------------------------<br>
